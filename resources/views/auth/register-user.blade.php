...
<div class="container">
        ...
        <div>
            ...
            <input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="username" placeholder="Entrez votre prénom et nom"/>
        ...
        <div class="flex items-center justify-end mt-4 text">
            ...
            <button type="submit" class="btn btn-login" name="submit">Inscription</button>
